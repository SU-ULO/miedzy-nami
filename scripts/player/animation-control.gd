...
func loadLook():
	...
	$"clothes-top".frames.add_frame("front", load_atlasable(currLook.getTopClothesPath(2, get_parent().color)))
	$"clothes-top".frames.add_frame("front", load_atlasable(currLook.getTopClothesPath(1, get_parent().color)))
	$"clothes-top".frames.add_frame("front", load_atlasable(currLook.getTopClothesPath(3, get_parent().color)))
	$"clothes-top".frames.add_frame("front", load_atlasable(currLook.getTopClothesPath(1, get_parent().color)))
	
	$"clothes-top".frames.add_frame("side", load_atlasable(currLook.getTopClothesPath(5, get_parent().color)))
	$"clothes-top".frames.add_frame("side", load_atlasable(currLook.getTopClothesPath(4, get_parent().color)))
	$"clothes-top".frames.add_frame("side", load_atlasable(currLook.getTopClothesPath(6, get_parent().color)))
	$"clothes-top".frames.add_frame("side", load_atlasable(currLook.getTopClothesPath(4, get_parent().color)))
	
	print(currLook.getTopClothesPath(4, get_parent().color))
	
	$"clothes-top".frames.add_frame("back", load_atlasable(currLook.getTopClothesPath(8, get_parent().color)))
	$"clothes-top".frames.add_frame("back", load_atlasable(currLook.getTopClothesPath(7, get_parent().color)))
	$"clothes-top".frames.add_frame("back", load_atlasable(currLook.getTopClothesPath(9, get_parent().color)))
	$"clothes-top".frames.add_frame("back", load_atlasable(currLook.getTopClothesPath(7, get_parent().color)))
