...
func loadLook():
	...
	$"clothes-top".frames.add_frame("walk front", load(currLook.getTopClothesPath(2, get_parent().color)))
	$"clothes-top".frames.add_frame("walk front", load(currLook.getTopClothesPath(1, get_parent().color)))
	$"clothes-top".frames.add_frame("walk front", load(currLook.getTopClothesPath(3, get_parent().color)))
	$"clothes-top".frames.add_frame("walk front", load(currLook.getTopClothesPath(1, get_parent().color)))
	$"clothes-top".frames.add_frame("walk side", load(currLook.getTopClothesPath(5, get_parent().color)))
	$"clothes-top".frames.add_frame("walk side", load(currLook.getTopClothesPath(4, get_parent().color)))
	$"clothes-top".frames.add_frame("walk side", load(currLook.getTopClothesPath(6, get_parent().color)))
	$"clothes-top".frames.add_frame("walk side", load(currLook.getTopClothesPath(4, get_parent().color)))
	$"clothes-top".frames.add_frame("walk back", load(currLook.getTopClothesPath(8, get_parent().color)))
	$"clothes-top".frames.add_frame("walk back", load(currLook.getTopClothesPath(7, get_parent().color)))
	$"clothes-top".frames.add_frame("walk back", load(currLook.getTopClothesPath(9, get_parent().color)))
	$"clothes-top".frames.add_frame("walk back", load(currLook.getTopClothesPath(7, get_parent().color)))
